...
// term id
// echo $table;
$get_details  = "INSERT INTO `period`(`period_name`) VALUES ('$time')";
...
<head>
    ...
    <title>Add Time Table - Admin</title>
</head>
...
<body>
    <div class="dashboard">
        ...
        <div class="dashboard-inner " id="main-bar">
            <div class="main-box">
                <h2>
                    Time  <?php echo $time ?> is Entered  Successfully!
                </h2>
                <a href="./index.php">
...
<head>
    ...
    <link rel="stylesheet" href="style.css">
    <script src="https://cdn.jsdelivr.net/npm/chart.js@2.8.0"></script>
    <title>Add Period time - Admin</title>
</head>
